...
from ActivityTracker import SystemMonitor, MissingProvider, UnusedProvider
...
class TestSystemMonitor(unittest.TestCase):    
        ...
        def testConfigHasNoProvider(self):
            ...
            self.assertRaises(MissingProvider, self.monitor, self.config)
        ...
        def testProviderHasNoConfig(self):
            ...
            self.assertRaises(UnusedProvider, self.monitor, self.config)
